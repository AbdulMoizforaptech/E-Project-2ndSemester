...
<body style="background-color: rgba(111, 66, 193, 0.1);">
    ...
    <div class="container mt-5" style="max-width:600px; width:100%;">
        ...
        <div class="form-group">
            ...
            <input type="number" class="form-control" id="cnic" name="cnic" placeholder="Enter your CNIC Number..." required>
        </div>  <!-- form-group -->
        <div class="form-group">
        ...
        if (isset($_POST['signup'])) {
            ...
            $query = "INSERT INTO tbl_patient (name, cnic, phone, c_id, address, gender, email, password, image) VALUES ('$name', '$cnic', '$phone', '$city', '$address', '$gender', '$email', '$password', '$path')";
